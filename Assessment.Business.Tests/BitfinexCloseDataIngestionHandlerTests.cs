...
{
    [TestClass]
    public class BitfinexCloseDataIngestionHandlerTests
    {

        private readonly Mock<AssessmentDbContext> contextMock;
        private readonly Mock<IHttpClientFactory> httpClientFactoryMock;
        private readonly Mock<ILogger<BitfinexCloseDataIngestionHandler>> loggerMock;
        private readonly BitfinexCloseDataIngestionHandler bitfinexCloseDataIngestionHandler;

        public BitfinexCloseDataIngestionHandlerTests()
        {
            contextMock = new Mock<AssessmentDbContext>();
            loggerMock = new Mock<ILogger<BitfinexCloseDataIngestionHandler>>();
            ...
            bitfinexCloseDataIngestionHandler = new BitfinexCloseDataIngestionHandler(
        ...
        {
            var list = new List<object> { 1672531200, 16000, 17000, 18000, 19000 };
            ...
            var result = await bitfinexCloseDataIngestionHandler.GetCloseDataIngestionResult(1672531200);
