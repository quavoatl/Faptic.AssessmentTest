...
{
    [TestClass]
    public class BitstampCloseDataIngestionHandlerTests
    {

        private readonly Mock<AssessmentDbContext> contextMock;
        private readonly Mock<IHttpClientFactory> httpClientFactoryMock;
        private readonly Mock<ILogger<BitstampCloseDataIngestionHandler>> loggerMock;

        private readonly BitstampCloseDataIngestionHandler bitstampCloseDataIngestionHandler;

        public BitstampCloseDataIngestionHandlerTests()
        {
            contextMock = new Mock<AssessmentDbContext>();
            loggerMock = new Mock<ILogger<BitstampCloseDataIngestionHandler>>();
            ...
            bitstampCloseDataIngestionHandler = new BitstampCloseDataIngestionHandler(
        ...
        {
            var bitstampApiResponse = new BitstampApiResponse
            {
            ...
            var expectedApiResponse = JsonConvert.SerializeObject(bitstampApiResponse);
            ...
            var result = await bitstampCloseDataIngestionHandler.GetCloseDataIngestionResult(1672531200);
